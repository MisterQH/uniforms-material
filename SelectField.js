...
var FormControlLabel_1 = tslib_1.__importDefault(
  require("@material-ui/core/FormControlLabel")
);
var FormGroup_1 = tslib_1.__importDefault(
  require("@material-ui/core/FormGroup")
);
var FormLabel_1 = tslib_1.__importDefault(
...
var renderSelect = function(_a) {
  var InputLabelProps = _a.InputLabelProps,
    allowedValues = _a.allowedValues,
    ...
    showInlineError = _a.showInlineError,
  ...
  return react_1.default.createElement(
    TextField_1.default,
    {
      ...
      InputLabelProps: tslib_1.__assign(
      ...
      SelectProps: tslib_1.__assign(
        {
          ...
          inputProps: tslib_1.__assign({ name: name, id: id }, inputProps),
          multiple: fieldType === Array || undefined,
          native: native
        },
        uniforms_1.filterDOMProps(props)
      ),
...
var renderCheckboxes = function(_a) {
  var allowedValues = _a.allowedValues,
  ...
  var children;
  var filteredProps = wrapField_1.default._filterDOMProps(
    uniforms_1.filterDOMProps(props)
  );
  if (fieldType !== Array) {
    children = react_1.default.createElement(
      RadioGroup_1.default,
      {
        ...
        name: name,
        onChange: function(event) {
          return disabled || onChange(event.target.value);
        },
        ref: inputRef,
        value: value
      },
      allowedValues.map(function(item) {
        return react_1.default.createElement(FormControlLabel_1.default, {
          control: react_1.default.createElement(
            Radio_1.default,
            tslib_1.__assign({ id: id + "-" + item }, filteredProps)
          ),
          key: item,
    ...
    var SelectionControl_1 =
      appearance === "checkbox" ? Checkbox_1.default : Switch_1.default;
    children = react_1.default.createElement(
      FormGroup_1.default,
      { id: id },
      allowedValues.map(function(item) {
            ...
            tslib_1.__assign(
              {
                ...
                name: name,
                onChange: function() {
                  return disabled || onChange(xor(item, value));
                },
                ref: inputRef,
                value: props.name
              },
...
var Select = function(_a) {
  var checkboxes = _a.checkboxes,
    props = tslib_1.__rest(_a, ["checkboxes"]);
